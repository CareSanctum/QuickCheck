...
import { ChevronRightIcon, Handshake, History, KeyRound, LogOutIcon, UserPen } from "lucide-react-native"
...
const AccountItemsCard = () => {
    ...
    const menuItems = [
        { id: 1, title: "Edit Profile", onPress: () => {}, icon: <UserPen size={22} color={foreground} /> },
        { id: 2, title: "Change Password", onPress: () => {}, icon: <KeyRound size={22} color={foreground} /> },
